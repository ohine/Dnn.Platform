<%@ Control Inherits="DotNetNuke.Modules.Admin.AdvancedSettings.AdvancedSettings" Language="C#" AutoEventWireup="True" EnableViewState="True" CodeBehind="AdvancedSettings.ascx.cs" %>
