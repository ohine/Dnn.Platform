<%@ Control Language="C#" Inherits="DotNetNuke.Modules.Admin.Analytics.GoogleAnalyticsSettings" AutoEventWireup="True" CodeBehind="GoogleAnalyticsSettings.ascx.cs" %>
