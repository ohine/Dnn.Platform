<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="EnableLocalizedContent.ascx.cs" Inherits="DotNetNuke.Modules.Admin.Languages.EnableLocalizedContent" Explicit="True"%>
