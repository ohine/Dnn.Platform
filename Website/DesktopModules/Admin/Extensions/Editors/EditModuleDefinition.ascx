<%@ Control Language="C#" AutoEventWireup="True" Inherits="DotNetNuke.Modules.Admin.ModuleDefinitions.CreateModuleDefinition" CodeBehind="EditModuleDefinition.ascx.cs" %>
